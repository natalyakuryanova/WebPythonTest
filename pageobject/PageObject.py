...
class OperationsHelper(BasePage):
    ...
    def get_user_text(self):
        ...
        logging.info(f"Found text Hello, {text} on open page {TestSearchLocators.LOCATOR_HELLO}")
        return text
    ...
    def get_new_title_text(self):
        ...
        logging.info(f"Found title '{text}' on open page {TestSearchLocators.LOCATOR_SEARCH_TITLE_FIELD[1]}")
        return text
    ...
    def enter_your_name(self, word):
        ...
        name_field = self.find_element(TestSearchLocators.LOCATOR_CONTACT_YOUR_NAME)
        name_field.clear()
    ...
    def enter_your_email(self, word):
        ...
        email_field = self.find_element(TestSearchLocators.LOCATOR_CONTACT_YOUR_EMAIL)
        email_field.clear()
    ...
    def get_alert_text(self):
        ...
        logging.info(f"Found text {text} in alert message")
        return text
